...
public static class ThatCollectionExtensions
{
	...
	/// </summary>
	public static AssertionResultAndOr<IEnumerable<TItem>, That<IEnumerable<TItem>>> Contains<TItem>(
	...
	/// </summary>
	public static AssertionResultAndOr<IEnumerable<TItem>, That<IEnumerable<TItem>>> IsEmpty<TItem>(
		this That<IEnumerable<TItem>> source)
	...
	/// </summary>
	public static AssertionResultAndOr<IEnumerable<TItem>, That<IEnumerable<TItem>>> IsNotEmpty<TItem>(
		this That<IEnumerable<TItem>> source)
