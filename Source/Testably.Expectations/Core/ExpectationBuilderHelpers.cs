...
{
	/// <summary>
	///     Appends the statement with the generic method with one type parameters and no method parameters.
	/// </summary>
	/// <remarks>
	///     Format: <br />
	...
	/// <summary>
	///     Appends the statement with the generic method with one type parameters and one method parameters.
	/// </summary>
	/// <remarks>
	///     Format: <br />
	...
	{
		return builder.AppendStatement(".").AppendStatement(methodName)
			.AppendStatement("<").AppendStatement(Formatter.Format(typeof(T1)))
			.AppendStatement(", ")
